...
let intervaloID
    ...
    function alterarContexto (contexto){
        ...
        switch (contexto) {
            case "foco":
                ...
                break;
                case "descanso-longo":
                titulo.innerHTML = `Hora de voltar a superfice.
    ...
    const ContagemRegressivaEmSegundos = ( () =>{
        if(tempoDecorridoEmSegundos <= 0 ){
            Audio.TempoFinalizado.play()
            zerar()
    ...
    function iniciarOuPausar() {
        ...
        audioPlay.play()
        intervaloID = setInterval(ContagemRegressivaEmSegundos, 1000)
